...
import 'package:personal_expenses_2/widgets/date_card.dart';
...
class _HistoryState extends State<History> {
  ...
  // This initState function will get all the list of transactions when
  // this History screen is opened
  @override
  void initState() {
    super.initState();
  ...
  // The the total list of transactions
  ...
  // This is add the DateCard widget to the list for kNumDays
